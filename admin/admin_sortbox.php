...
$field_to_sort = isset($_GET['field_to_sort']) ? xss($_GET['field_to_sort']) : (isset($_POST['field_to_sort']) ? xss($_POST['field_to_sort']) : '');
$extra_value = isset($_GET['extra_value']) ? xss($_GET['extra_value']) : (isset($_POST['extra_value']) ? xss($_POST['extra_value']) : '');

$options = array ('field_to_sort' => $field_to_sort,
