<?php
/**
 * holiday file for North Rhine-Westphalia
 *
 ...
 * @version    $Id: specialdays_germany_nw.php,v 1.3 2007-05-31 08:12:02 gustavo Exp $
 */
if (!defined('lib_included')) die('Please use index.php!');


class SpecialDays_Germany_NW
{
	var $name;

	function SpecialDays_Germany_NW()
	{
		$this->name =  __("North Rhine-Westphalia");
	}
