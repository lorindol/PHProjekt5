 ...
 * @version    $Id: specialdays_germany_sn.php,v 1.3 2007-05-31 08:12:02 gustavo Exp $
 */
if (!defined('lib_included')) die('Please use index.php!');


class SpecialDays_Germany_SN
{
	var $name;

	function SpecialDays_Germany_SN()
	{
		$this->name =  __("Saxony");
	}
	...
	function calculate_holidays($year)
	{
		...
		$data[] = array("date"=>strtotime("-11 days", strtotime("1 sunday", mktime(0,0,0,11,26,$year))),
						"name"=>'Bu&szlig;- und Bettag',
						"type"=>PHPR_SD_HOLIDAYS);						
		return $data;
	}
