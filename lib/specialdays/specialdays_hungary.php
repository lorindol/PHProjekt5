 ...
 * @version    $Id: specialdays_hungary.php,v 1.3 2007-05-31 08:12:02 gustavo Exp $
 */
if (!defined('lib_included')) die('Please use index.php!');

class SpecialDays_Hungary

{
	var $name;

	function SpecialDays_Hungary()
	{
		$this->name = __("Hungary");
	}
	...
	function calculate_holidays($year)
	{
		...
		$data[] = array("date"=>mktime(0,0,0,3,15,$year),
						"name"=>'National Day',
						"type"=>PHPR_SD_HOLIDAYS);
		...
		$data[] = array("date"=>mktime(0,0,0,10,23,$year),
						"name"=>'National Day',
						"type"=>PHPR_SD_HOLIDAYS);
