<?php
/**
 * holiday file for baden-wuerttemberg
 *
 ...
 * @version    $Id: specialdays_germany_bw.php,v 1.3 2007-05-31 08:12:02 gustavo Exp $
 */
if (!defined('lib_included')) die('Please use index.php!');


class SpecialDays_Germany_BW
{
	var $name;

	function SpecialDays_Germany_BW()
	{
		$this->name =  __("Baden-Wuerttemberg");
	}
