<?php
/**
* holiday file for Augsburg, Germany
*
...
* @package    calendar
* @module     main
* @author     Alex Reil, David Soria Parra, ying lu, $Author: albrecht $
* @licence    GPL, see www.gnu.org/copyleft/gpl.html
* @copyright  2000-2006 Mayflower GmbH www.mayflower.de
* @version    $Id: specialdays_germany_augsburg.php,v 1.2 2008-03-04 10:52:00 albrecht Exp $
*/
if (!defined('lib_included')) die('Please use index.php!');


class Specialdays_Germany_Augsburg
{
	var $name;

	function Specialdays_Germany_Augsburg()
	{
		$this->name =  'Augsburg';
	}
	...
	function calculate_holidays($year)
	{
		$es = easter_days($year);
		$data 	= array();
		$data[] = array("date"=>mktime(0,0,0,8,8,$year),
						"name"=>'Friedensfest',
